...
export function ActionRonde({ icone, label, couleur, onClick }: ActionRondeProps) {
  return (
    ...
    >
      <span
        className="flex items-center justify-center w-16 h-16 rounded-full text-2xl text-[var(--color-texte-sur-accent)] shadow-[var(--ombre-forte)] transition-transform group-active:scale-90"
